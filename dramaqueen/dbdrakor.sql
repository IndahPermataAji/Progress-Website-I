...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2020 at 08:20 AM
...
INSERT INTO `complete` (`id`, `judul`, `tahun`, `jumlah_ep`, `genre`, `negara`) VALUES
(1, 'School 2015', 2015, 16, 'School, Romance', 'Korea Selatan'),
(2, 'Hotel Del Luna', 2019, 16, 'Horor, Romance', 'Korea Selatan');
...
INSERT INTO `ongoing` (`id`, `judul`, `tahun`, `jumlah_ep`, `genre`, `negara`) VALUES
(1, '18 Again', 2020, 16, 'Fantasy,School,Romance', 'Korea Selatan'),
(2, 'It\'s Okay To Not Be Okay', 2020, 16, 'Romace, Mystery', 'Korea Selatan');
