...
if($_POST){
	...
	$sql = "UPDATE ongoing SET id ='".$_POST['id']."', judul='".$_POST['judul']."', tahun='".$_POST['tahun']."', jumlah_ep='".$_POST['jumlah_ep']."', genre='".$_POST['genre']."', negara ='".$_POST['negara']."' WHERE id=".$_POST['id'];
	...
	$query = $koneksi->query("SELECT * FROM ongoing WHERE id=".$_GET['id']);
